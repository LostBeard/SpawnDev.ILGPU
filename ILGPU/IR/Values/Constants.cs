...
namespace ILGPU.IR.Values
{
    ...
    public sealed class PrimitiveValue : ConstantNode
    {
        ...
        /// <summary>
        /// Returns the value as a 4-bit float in E2M1 layout (low nibble of the byte).
        /// </summary>
        ...
        public bool HasFloatValue(float f32Value, double f64Value) =>
            BasicValueType switch
            {
                ...
                BasicValueType.Float4E2M1 => Float4E2M1Value == f32Value,
        ...
        protected override string ToArgString()
        {
            string result = BasicValueType switch
            {
                ...
                BasicValueType.Float4E2M1 => Float4E2M1Value.ToString(),
